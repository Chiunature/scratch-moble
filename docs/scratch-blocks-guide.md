...
| `scripts/sync-to-mobile.mjs` | 将 `dist/index.html` 写入 `apps/mobile/assets/editor/editorBundle.html`。                                                                                                                                                                                     |
...
- `apps/mobile/assets/editor/editorBundle.html`（由 `yarn editor:web` 生成，勿手改）
